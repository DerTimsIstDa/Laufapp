 ...
 *   views/training.js Trainingsformular und Planliste
 *   views/stats.js    Statistik, Aktivitaetsraster, Pace-Verlauf, Bestzeiten
 */
...
function renderProfile() {
  ...
  renderGoal();
  renderPeriodStats();
  renderProfileStats(runs);
  renderActivity(runs);
  renderPaceTrend(runs);
  renderBestTimes(runs);
}
